...
class Level_01(Level):
    ...
    def __init__(self, jugador):
        ...
        objetos_puntos = [[provisiones.botiquin, 500, 100],
                          ...
                          [provisiones.botiquin, 4900, 400],
                          [provisiones.botella, 6000, 500],
                          [provisiones.banana, 7050, 400],
                          [provisiones.botiquin, 8050, 500],
                          [provisiones.botella, 9000, 300],
                          [provisiones.banana, 10000, 500],
                          [provisiones.botiquin, 11000, 200],
                          [provisiones.botella, 12000, 600],
                          [provisiones.banana, 13050, 300],
                          [provisiones.botella, 14000, 400],
                          [provisiones.botiquin, 15000, 500],
